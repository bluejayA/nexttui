...
- glance-domain (24 tests) — commit d585a5a
- identity-domain (35 tests) — commit c384123
- nova-admin-domain (16 tests) — commit c433684
- admin-monitoring (7 tests) — commit 3506be6
- integration (2 tests) — commit a6cf04c
