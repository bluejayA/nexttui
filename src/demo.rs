...
use crate::models::nova::{Address, Flavor, FlavorRef, ImageRef, Server, ServerSecurityGroup};
...
pub fn create_demo_app() -> Result<(App, ActionReceiver), Box<dyn std::error::Error>> {
    ...
    rbac.update_roles(
        vec![crate::port::types::TokenRole {
            id: "r1".into(),
            name: "admin".into(),
        }],
        None,
...
fn demo_servers() -> Vec<Server> {
    vec![
        Server {
                ...
                m.insert(
                    ...
                    vec![
                        Address {
                            addr: "10.0.1.10".into(),
                            version: 4,
                            mac_addr: Some("fa:16:3e:aa:bb:01".into()),
            ...
            flavor: FlavorRef {
                id: "flv-1".into(),
                original_name: Some("m1.large".into()),
                vcpus: Some(4),
                ram: Some(8192),
                disk: Some(80),
            },
            ...
            addresses: {
                ...
                m.insert(
                    ...
                    vec![Address {
                        addr: "10.0.1.11".into(),
                        version: 4,
                        mac_addr: Some("fa:16:3e:aa:bb:02".into()),
                        ip_type: Some("fixed".into()),
                    }],
                );
                m
        ...
        Server {
            ...
            addresses: {
                ...
                m.insert(
                    ...
                    vec![Address {
                        addr: "10.0.2.10".into(),
                        version: 4,
                        mac_addr: Some("fa:16:3e:cc:dd:01".into()),
                        ip_type: Some("fixed".into()),
                    }],
                );
                m
            ...
            flavor: FlavorRef {
                id: "flv-2".into(),
                original_name: Some("m1.xlarge".into()),
                vcpus: Some(8),
                ram: Some(16384),
                disk: Some(160),
            },
        ...
        Server {
            ...
            addresses: {
                ...
                m.insert(
                    ...
                    vec![Address {
                        addr: "10.0.1.20".into(),
                        version: 4,
                        mac_addr: Some("fa:16:3e:ee:ff:01".into()),
                        ip_type: Some("fixed".into()),
                    }],
                );
                m
            ...
            flavor: FlavorRef {
                id: "flv-3".into(),
                original_name: Some("m1.medium".into()),
                vcpus: Some(2),
                ram: Some(4096),
                disk: Some(40),
            },
            ...
            volumes_attached: vec![],
            security_groups: vec![ServerSecurityGroup {
                name: "default".into(),
            }],
        },
        Server {
...
fn demo_networks() -> Vec<Network> {
    vec![
        ...
        Network {
            ...
            subnets: vec!["sub-ext-1".into()],
            provider_network_type: Some("flat".into()),
            provider_physical_network: Some("physnet1".into()),
        ...
        SecurityGroup {
            ...
            security_group_rules: vec![
                SecurityGroupRule {
                    ...
                    direction: "ingress".into(),
                    protocol: Some("tcp".into()),
                    port_range_min: Some(3306),
                    port_range_max: Some(3306),
                    remote_ip_prefix: Some("10.0.1.0/24".into()),
                    remote_group_id: None,
                    ethertype: "IPv4".into(),
                },
                SecurityGroupRule {
                    ...
                    direction: "ingress".into(),
                    protocol: Some("tcp".into()),
                    port_range_min: Some(5432),
                    port_range_max: Some(5432),
                    remote_ip_prefix: Some("10.0.1.0/24".into()),
                    remote_group_id: None,
                    ethertype: "IPv4".into(),
                },
...
fn demo_floating_ips() -> Vec<FloatingIp> {
    vec![
        FloatingIp {
            ...
            floating_network_id: "net-ext-1".into(),
            fixed_ip_address: Some("10.0.1.10".into()),
            router_id: Some("router-1".into()),
            tenant_id: None,
        },
        FloatingIp {
            id: "fip-2".into(),
            floating_ip_address: "203.0.113.11".into(),
            status: "DOWN".into(),
            port_id: None,
            floating_network_id: "net-ext-1".into(),
        ...
        FloatingIp {
            id: "fip-3".into(),
            floating_ip_address: "203.0.113.12".into(),
            status: "ACTIVE".into(),
            port_id: Some("port-3".into()),
            floating_network_id: "net-ext-1".into(),
            fixed_ip_address: Some("10.0.2.10".into()),
            router_id: Some("router-1".into()),
            tenant_id: None,
        },
    ]
...
fn demo_volumes() -> Vec<Volume> {
    vec![
        Volume {
            id: "vol-boot-1".into(),
            name: Some("web-prod-01-boot".into()),
            description: Some("Boot volume".into()),
            status: "in-use".into(),
            size: 80,
            ...
            attachments: vec![VolumeAttachment {
                server_id: "a1b2c3d4-1111-2222-3333-444455556666".into(),
                device: "/dev/vda".into(),
                id: "att-1".into(),
            }],
            availability_zone: Some("az1".into()),
            created_at: Some("2026-01-15T09:30:00Z".into()),
            tenant_id: None,
        },
        Volume {
            id: "vol-data-1".into(),
            name: Some("db-data".into()),
            description: Some("Database data volume".into()),
            status: "in-use".into(),
            size: 500,
            volume_type: Some("ssd".into()),
            encrypted: true,
            bootable: "false".into(),
            attachments: vec![VolumeAttachment {
                server_id: "c3d4e5f6-3333-4444-5555-666677778888".into(),
                device: "/dev/vdb".into(),
                id: "att-2".into(),
            }],
            availability_zone: Some("az1".into()),
            created_at: Some("2026-02-01T10:05:00Z".into()),
            tenant_id: None,
        },
        Volume {
            id: "vol-backup-1".into(),
            name: Some("backup-storage".into()),
            description: None,
            status: "available".into(),
            size: 1000,
            volume_type: Some("hdd".into()),
            encrypted: false,
            bootable: "false".into(),
            attachments: vec![],
            availability_zone: Some("az2".into()),
...
fn demo_snapshots() -> Vec<VolumeSnapshot> {
    vec![
        VolumeSnapshot {
            id: "snap-daily-1".into(),
            name: Some("db-data-daily-0324".into()),
            status: "available".into(),
            size: 500,
            volume_id: "vol-data-1".into(),
            created_at: Some("2026-03-24T02:00:00Z".into()),
            tenant_id: None,
        },
        VolumeSnapshot {
            id: "snap-daily-2".into(),
            name: Some("db-data-daily-0323".into()),
            status: "available".into(),
            size: 500,
            volume_id: "vol-data-1".into(),
            created_at: Some("2026-03-23T02:00:00Z".into()),
            tenant_id: None,
        },
    ]
}
...
fn demo_images() -> Vec<Image> {
    vec![
        Image {
            ...
            size: Some(2_415_919_104),
            visibility: "public".into(),
            min_disk: 10,
            min_ram: 512,
            checksum: Some("d4e5f6a7b8c9".into()),
            created_at: Some("2026-01-01T00:00:00Z".into()),
            owner: None,
        },
        Image {
            id: "img-2".into(),
            name: "CentOS 9 Stream".into(),
            status: "active".into(),
            disk_format: Some("qcow2".into()),
            container_format: Some("bare".into()),
            ...
            min_disk: 10,
            min_ram: 512,
            checksum: Some("a1b2c3d4e5f6".into()),
            created_at: Some("2026-01-10T00:00:00Z".into()),
            owner: None,
        },
        Image {
            id: "img-3".into(),
            ...
            disk_format: Some("qcow2".into()),
            container_format: Some("bare".into()),
            size: Some(16_106_127_360),
            visibility: "private".into(),
            min_disk: 40,
            min_ram: 4096,
            checksum: Some("f6e5d4c3b2a1".into()),
            created_at: Some("2026-02-15T00:00:00Z".into()),
            owner: None,
        },
        Image {
            id: "img-4".into(),
            ...
            min_ram: 512,
            checksum: None,
            created_at: Some("2025-12-01T00:00:00Z".into()),
            owner: None,
        },
    ]
}
...
fn demo_projects() -> Vec<Project> {
    vec![
        ...
        Project {
            id: "proj-demo".into(),
            name: "demo".into(),
            description: Some("Demo/test project".into()),
            enabled: true,
            domain_id: Some("default".into()),
        },
        Project {
            id: "proj-staging".into(),
            name: "staging".into(),
        ...
        Project {
            ...
            description: Some("Deprecated project".into()),
            enabled: false,
            domain_id: Some("default".into()),
        },
    ]
...
mod tests {
    ...
    fn test_demo_app_is_admin() {
        let (app, _rx) = create_demo_app().unwrap();
